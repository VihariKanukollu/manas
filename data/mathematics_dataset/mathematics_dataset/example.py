...
# WorldProblem is for "math as world model" training: includes step-by-step solution trace
WorldProblem = collections.namedtuple('WorldProblem', ('equation', 'steps', 'final_answer'))
